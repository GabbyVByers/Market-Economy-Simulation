...
pygame.display.set_caption("Market Simulation Version 4.0")
...
GermanyMenuButtonX = int(GraphBaseX + (GraphWidth/2) - (((6*MenuBorderWidth)+GermanyMenuTEXT.get_width()+FranceMenuTEXT.get_width()+GlobeMenuTEXT.get_width())/2))
...
FranceMenuButtonX = int(GraphBaseX + GermanyMenuWidth + (GraphWidth/2) - (((6*MenuBorderWidth)+GermanyMenuTEXT.get_width()+FranceMenuTEXT.get_width()+GlobeMenuTEXT.get_width())/2))
FranceMenuButtonY = int((GraphBaseY/2) - (FranceMenuButtonHeight/2))

GlobeMenuButtonWidth = GlobeMenuTEXT.get_width() + (2*MenuBorderWidth)
GlobeMenuButtonHeight = GlobeMenuTEXT.get_height() + (2*MenuBorderWidth)
GlobeMenuButtonX = int(GraphBaseX + GermanyMenuWidth + FranceMenuButtonWidth + (GraphWidth/2) - (((6*MenuBorderWidth)+GermanyMenuTEXT.get_width()+FranceMenuTEXT.get_width()+GlobeMenuTEXT.get_width())/2))
GlobeMenuButtonY = int((GraphBaseY/2) - (GlobeMenuButtonHeight/2))
...
GermanyGraphTenHeight = 5000 #Wage Rate
...
FranceGraphTenHeight = 5000 #Wage Rate
FranceGraphElevenHeight = 0.02 #MUΔ$ABC
FranceGraphTwelveHeight = 200 #ΔQABC*PABC

GraphOneHeightStepSize = 1
GraphTwoHeightStepSize = 5
GraphThreeHeightStepSize = 1
GraphFourHeightStepSize = 25
GraphFiveHeightStepSize = 1
GraphSixHeightStepSize = 50
GraphSevenHeightStepSize = 1
GraphEightHeightStepSize = 1
GraphNineHeightStepSize = 50
GraphTenHeightStepSize = 1
GraphElevenHeightStepSize = 1
GraphTwelveHeightStepSize = 1

GraphOneHeightMax = 999999
GraphTwoHeightMax = 999999
GraphThreeHeightMax = 999999
GraphFourHeightMax = 1000
GraphFiveHeightMax = 999999
GraphSixHeightMax = 999999
GraphSevenHeightMax = 999999
GraphEightHeightMax = 999999
GraphNineHeightMax = 999999
GraphTenHeightMax = 999999
GraphElevenHeightMax = 999999
GraphTwelveHeightMax = 999999

GraphOneHeightMin = 0
GraphTwoHeightMin = 0
GraphThreeHeightMin = 0
GraphFourHeightMin = 200
GraphFiveHeightMin = 0
GraphSixHeightMin = 0
GraphSevenHeightMin = 0
GraphEightHeightMin = 0
GraphNineHeightMin = 0
GraphTenHeightMin = 0
GraphElevenHeightMin = 0
GraphTwelveHeightMin = 0
...
def Game():
    ...
    pygame.draw.rect(win, Dark_Gray2, (GlobeMenuButtonX,GlobeMenuButtonY,GlobeMenuButtonWidth,GlobeMenuButtonHeight))
    ...
    win.blit(GlobeMenuTEXT, (GlobeMenuButtonX+MenuBorderWidth,GlobeMenuButtonY+MenuBorderWidth))
    ...
    if (MouseOver == "GlobeMenuButton"):
        pygame.draw.rect(win, White, (GlobeMenuButtonX,GlobeMenuButtonY,GlobeMenuButtonWidth,GlobeMenuButtonHeight), 1)
...
def DrawBoxesLast():
    ...
    #pygame.draw.rect(win, Dark_Gray1, (GraphFiveX,GraphFiveY,GraphWidth,GraphHeight), 1) ##########
    ...
    #pygame.draw.rect(win, Dark_Gray1, (GraphEightX,GraphEightY,GraphWidth,GraphHeight), 1) ##########
...
def DrawGermanySliders():
    ...
    pygame.draw.rect(win, Dark_Gray1, (SliderX,SliderElevenY,SliderWidth,SliderThickness))
    pygame.draw.rect(win, Dark_Gray1, (SliderX,SliderTwelveY,SliderWidth,SliderThickness))
    pygame.draw.rect(win, Dark_Gray1, (SliderX,SliderThirteenY,SliderWidth,SliderThickness))
    ...
    win.blit(SubsidyAText, (SliderX+SliderNameDisplacementX,SliderElevenY+SliderNameDisplacementY))
    win.blit(SubsidyBText, (SliderX+SliderNameDisplacementX,SliderTwelveY+SliderNameDisplacementY))
    win.blit(SubsidyCText, (SliderX+SliderNameDisplacementX,SliderThirteenY+SliderNameDisplacementY))
    ...
    pygame.draw.rect(win, Red, (GermanySliderDotElevenX,SliderElevenY,SliderThickness,SliderThickness))
    pygame.draw.rect(win, Red, (GermanySliderDotTwelveX,SliderTwelveY,SliderThickness,SliderThickness))
    pygame.draw.rect(win, Red, (GermanySliderDotThirteenX,SliderThirteenY,SliderThickness,SliderThickness))
    ...
    if (SliderSelection == "Eleven"):
        pygame.draw.rect(win, White, (GermanySliderDotElevenX,SliderElevenY,SliderThickness,SliderThickness))
    if (SliderSelection == "Twelve"):
        pygame.draw.rect(win, White, (GermanySliderDotTwelveX,SliderTwelveY,SliderThickness,SliderThickness))
    if (SliderSelection == "Thirteen"):
        pygame.draw.rect(win, White, (GermanySliderDotThirteenX,SliderThirteenY,SliderThickness,SliderThickness))
...
def DrawFranceSliders():
    ...
    pygame.draw.rect(win, Red, (FranceSliderDotElevenX,SliderElevenY,SliderThickness,SliderThickness))
    pygame.draw.rect(win, Red, (FranceSliderDotTwelveX,SliderTwelveY,SliderThickness,SliderThickness))
    pygame.draw.rect(win, Red, (FranceSliderDotThirteenX,SliderThirteenY,SliderThickness,SliderThickness))
    ...
    if (SliderSelection == "Eleven"):
        pygame.draw.rect(win, White, (FranceSliderDotElevenX,SliderElevenY,SliderThickness,SliderThickness))
    if (SliderSelection == "Twelve"):
        pygame.draw.rect(win, White, (FranceSliderDotTwelveX,SliderTwelveY,SliderThickness,SliderThickness))
    if (SliderSelection == "Thirteen"):
        pygame.draw.rect(win, White, (FranceSliderDotThirteenX,SliderThirteenY,SliderThickness,SliderThickness))

#Globe Menu
def DrawGlobeMenu():
    win.blit(DummyTextGlobe, (int(DisplayX/2),int(DisplayY/2)))
...
while run == True:
    ...
    for event in pygame.event.get():
        ...
        if (GlobeMenuButtonX < MouseX < GlobeMenuButtonX+GlobeMenuButtonWidth) and (GlobeMenuButtonY < MouseY < GlobeMenuButtonY+GlobeMenuButtonHeight) and (event.type == pygame.MOUSEBUTTONDOWN):
            MenuSelection = "Globe"
        ...
        #Click on Slider
        if (event.type == pygame.MOUSEBUTTONDOWN) and (SliderHitboxX < MouseX < SliderHitboxX + SliderHitboxWidth) and (SliderOneHitboxY < MouseY < SliderOneHitboxY + SliderHitboxHeight):
            SliderSelection = "One"
        if (event.type == pygame.MOUSEBUTTONDOWN) and (SliderHitboxX < MouseX < SliderHitboxX + SliderHitboxWidth) and (SliderTwoHitboxY < MouseY < SliderTwoHitboxY + SliderHitboxHeight):
            SliderSelection = "Two"
        if (event.type == pygame.MOUSEBUTTONDOWN) and (SliderHitboxX < MouseX < SliderHitboxX + SliderHitboxWidth) and (SliderThreeHitboxY < MouseY < SliderThreeHitboxY + SliderHitboxHeight):
            SliderSelection = "Three"
        if (event.type == pygame.MOUSEBUTTONDOWN) and (SliderHitboxX < MouseX < SliderHitboxX + SliderHitboxWidth) and (SliderFourHitboxY < MouseY < SliderFourHitboxY + SliderHitboxHeight):
            SliderSelection = "Four"
        if (event.type == pygame.MOUSEBUTTONDOWN) and (SliderHitboxX < MouseX < SliderHitboxX + SliderHitboxWidth) and (SliderFiveHitboxY < MouseY < SliderFiveHitboxY + SliderHitboxHeight):
            SliderSelection = "Five"
        if (event.type == pygame.MOUSEBUTTONDOWN) and (SliderHitboxX < MouseX < SliderHitboxX + SliderHitboxWidth) and (SliderSixHitboxY < MouseY < SliderSixHitboxY + SliderHitboxHeight):
            SliderSelection = "Six"
        if (event.type == pygame.MOUSEBUTTONDOWN) and (SliderHitboxX < MouseX < SliderHitboxX + SliderHitboxWidth) and (SliderSevenHitboxY < MouseY < SliderSevenHitboxY + SliderHitboxHeight):
            SliderSelection = "Seven"
        if (event.type == pygame.MOUSEBUTTONDOWN) and (SliderHitboxX < MouseX < SliderHitboxX + SliderHitboxWidth) and (SliderEightHitboxY < MouseY < SliderEightHitboxY + SliderHitboxHeight):
            SliderSelection = "Eight"
        if (event.type == pygame.MOUSEBUTTONDOWN) and (SliderHitboxX < MouseX < SliderHitboxX + SliderHitboxWidth) and (SliderNineHitboxY < MouseY < SliderNineHitboxY + SliderHitboxHeight):
            SliderSelection = "Nine"
        if (event.type == pygame.MOUSEBUTTONDOWN) and (SliderHitboxX < MouseX < SliderHitboxX + SliderHitboxWidth) and (SliderTenHitboxY < MouseY < SliderTenHitboxY + SliderHitboxHeight):
            SliderSelection = "Ten"
        if (event.type == pygame.MOUSEBUTTONDOWN) and (SliderHitboxX < MouseX < SliderHitboxX + SliderHitboxWidth) and (SliderElevenHitboxY < MouseY < SliderElevenHitboxY + SliderHitboxHeight):
            SliderSelection = "Eleven"
        if (event.type == pygame.MOUSEBUTTONDOWN) and (SliderHitboxX < MouseX < SliderHitboxX + SliderHitboxWidth) and (SliderTwelveHitboxY < MouseY < SliderTwelveHitboxY + SliderHitboxHeight):
            SliderSelection = "Twelve"
        if (event.type == pygame.MOUSEBUTTONDOWN) and (SliderHitboxX < MouseX < SliderHitboxX + SliderHitboxWidth) and (SliderThirteenHitboxY < MouseY < SliderThirteenHitboxY + SliderHitboxHeight):
            SliderSelection = "Thirteen"
        if (event.type == pygame.MOUSEBUTTONUP):
            SliderSelection = "None"

        #Mouse Over Graph
        MouseOverGraph = 0
        if (MenuSelection == "Germany") or (MenuSelection == "France"):
    ...
    if (PAUSE == False) or (STEP == True):
        ...
        #prices
        GermanyPriceA = (GermanyMoneyDemandDomesticA + FranceMoneyDemandForeignA) / GermanySupplyA
        GermanyPriceB = (GermanyMoneyDemandDomesticB + FranceMoneyDemandForeignB) / GermanySupplyB
        GermanyPriceC = (GermanyMoneyDemandDomesticC + FranceMoneyDemandForeignC) / GermanySupplyC

        FrancePriceA = (FranceMoneyDemandDomesticA + GermanyMoneyDemandForeignA) / FranceSupplyA
        FrancePriceB = (FranceMoneyDemandDomesticB + GermanyMoneyDemandForeignB) / FranceSupplyB
        FrancePriceC = (FranceMoneyDemandDomesticC + GermanyMoneyDemandForeignC) / FranceSupplyC

        #Anticipated Demand
        GermanyAnticipatedDemandA = (GermanyMoneyDemandDomesticA/GermanyPriceA) + (GermanyMoneyDemandForeignA/FrancePriceA)
        GermanyAnticipatedDemandB = (GermanyMoneyDemandDomesticB/GermanyPriceB) + (GermanyMoneyDemandForeignB/FrancePriceB)
        GermanyAnticipatedDemandC = (GermanyMoneyDemandDomesticC/GermanyPriceC) + (GermanyMoneyDemandForeignC/FrancePriceC)

        FranceAnticipatedDemandA = (FranceMoneyDemandDomesticA/FrancePriceA) + (FranceMoneyDemandForeignA/GermanyPriceA)
        FranceAnticipatedDemandB = (FranceMoneyDemandDomesticB/FrancePriceB) + (FranceMoneyDemandForeignB/GermanyPriceB)
        FranceAnticipatedDemandC = (FranceMoneyDemandDomesticC/FrancePriceC) + (FranceMoneyDemandForeignC/GermanyPriceC)
        
        #MUΔ$ABC (use lowest global prices)
        GermanyMarginalUtilityMoneySpentA = GermanyMarginalUtilityFunctionA(GermanyAnticipatedDemandA) / min(GermanyPriceA,FrancePriceA)
        GermanyMarginalUtilityMoneySpentB = GermanyMarginalUtilityFunctionB(GermanyAnticipatedDemandB) / min(GermanyPriceB,FrancePriceB)
        GermanyMarginalUtilityMoneySpentC = GermanyMarginalUtilityFunctionC(GermanyAnticipatedDemandC) / min(GermanyPriceC,FrancePriceC)

        FranceMarginalUtilityMoneySpentA = FranceMarginalUtilityFunctionA(FranceAnticipatedDemandA) / min(GermanyPriceA,FrancePriceA)
        FranceMarginalUtilityMoneySpentB = FranceMarginalUtilityFunctionB(FranceAnticipatedDemandB) / min(GermanyPriceA,FrancePriceB)
        FranceMarginalUtilityMoneySpentC = FranceMarginalUtilityFunctionC(FranceAnticipatedDemandC) / min(GermanyPriceA,FrancePriceC)
        ...
        GermanyMarketIncomeA = GermanyMoneyDemandDomesticA + FranceMoneyDemandForeignA
        GermanyMarketIncomeB = GermanyMoneyDemandDomesticB + FranceMoneyDemandForeignB
        GermanyMarketIncomeC = GermanyMoneyDemandDomesticC + FranceMoneyDemandForeignC

        FranceMarketIncomeA = FranceMoneyDemandDomesticA + GermanyMoneyDemandForeignA
        FranceMarketIncomeB = FranceMoneyDemandDomesticB + GermanyMoneyDemandForeignB
        FranceMarketIncomeC = FranceMoneyDemandDomesticC + GermanyMoneyDemandForeignC
        
        #National Income
        GermanyIncome = GermanyMarketIncomeA + GermanyMarketIncomeB + GermanyMarketIncomeC
        FranceIncome = FranceMarketIncomeA + FranceMarketIncomeB + FranceMarketIncomeC
    ...
    if (GlobeMenuButtonX < MouseX < GlobeMenuButtonX+GlobeMenuButtonWidth) and (GlobeMenuButtonY < MouseY < GlobeMenuButtonY+GlobeMenuButtonHeight):
        MouseOver = "GlobeMenuButton"
    ...
    if (MenuSelection == "Germany"):
        ...
        VariableTotalExports_TEXT = font1.render("$"+str(round(FranceMoneyDemandForeignA+FranceMoneyDemandForeignB+FranceMoneyDemandForeignC)), 1, White)
        VariableExportsA = font1.render("$"+str(round(FranceMoneyDemandForeignA)), 1, Blue)
        VariableExportsB = font1.render("$"+str(round(FranceMoneyDemandForeignB)), 1, Red)
        VariableExportsC = font1.render("$"+str(round(FranceMoneyDemandForeignC)), 1, Green)
        VariableTotalImports_TEXT = font1.render("$"+str(round(GermanyMoneyDemandForeignA+GermanyMoneyDemandForeignB+GermanyMoneyDemandForeignC)), 1, White)
        VariableImportsA = font1.render("$"+str(round(GermanyMoneyDemandForeignA)), 1, Blue)
        VariableImportsB = font1.render("$"+str(round(GermanyMoneyDemandForeignB)), 1, Red)
        VariableImportsC = font1.render("$"+str(round(GermanyMoneyDemandForeignC)), 1, Green)
    ...
    if (MenuSelection == "France"):
        ...
        VariableTotalExports_TEXT = font1.render("$"+str(round(GermanyMoneyDemandForeignA+GermanyMoneyDemandForeignB+GermanyMoneyDemandForeignC)), 1, White)
        VariableExportsA = font1.render("$"+str(round(GermanyMoneyDemandForeignA)), 1, Blue)
        VariableExportsB = font1.render("$"+str(round(GermanyMoneyDemandForeignB)), 1, Red)
        VariableExportsC = font1.render("$"+str(round(GermanyMoneyDemandForeignC)), 1, Green)
        VariableTotalImports_TEXT = font1.render("$"+str(round(FranceMoneyDemandForeignA+FranceMoneyDemandForeignB+FranceMoneyDemandForeignC)), 1, White)
        VariableImportsA = font1.render("$"+str(round(FranceMoneyDemandForeignA)), 1, Blue)
        VariableImportsB = font1.render("$"+str(round(FranceMoneyDemandForeignB)), 1, Red)
        VariableImportsC = font1.render("$"+str(round(FranceMoneyDemandForeignC)), 1, Green)
    ...
    if (PAUSE == False) or (STEP == True):
        ...
        GermanyRawExportABCList.append((GraphSixX+len(GermanyRawExportABCList),FranceMoneyDemandForeignA+FranceMoneyDemandForeignB+FranceMoneyDemandForeignC))
        ...
        GermanyRawExportBCList.append((GraphSixX+len(GermanyRawExportBCList),FranceMoneyDemandForeignB+FranceMoneyDemandForeignC))
        ...
        GermanyRawExportCList.append((GraphSixX+len(GermanyRawExportCList),FranceMoneyDemandForeignC))
        ...
        GermanyRawImportABCList.append((GraphNineX+len(GermanyRawImportABCList),GermanyMoneyDemandForeignA+GermanyMoneyDemandForeignB+GermanyMoneyDemandForeignC))
        ...
        GermanyRawImportBCList.append((GraphNineX+len(GermanyRawImportBCList),GermanyMoneyDemandForeignB+GermanyMoneyDemandForeignC))
        ...
        GermanyRawImportCList.append((GraphNineX+len(GermanyRawImportCList),GermanyMoneyDemandForeignC))
        ...
        FranceRawExportABCList.append((GraphSixX+len(FranceRawExportABCList),GermanyMoneyDemandForeignA+GermanyMoneyDemandForeignB+GermanyMoneyDemandForeignC))
        ...
        FranceRawExportBCList.append((GraphSixX+len(FranceRawExportBCList),GermanyMoneyDemandForeignB+GermanyMoneyDemandForeignC))
        ...
        FranceRawExportCList.append((GraphSixX+len(FranceRawExportCList),GermanyMoneyDemandForeignC))
        ...
        FranceRawImportABCList.append((GraphNineX+len(FranceRawImportABCList),FranceMoneyDemandForeignA+FranceMoneyDemandForeignB+FranceMoneyDemandForeignC))
        ...
        FranceRawImportBCList.append((GraphNineX+len(FranceRawImportBCList),FranceMoneyDemandForeignB+FranceMoneyDemandForeignC))
        ...
        FranceRawImportCList.append((GraphNineX+len(FranceRawImportCList),FranceMoneyDemandForeignC))
