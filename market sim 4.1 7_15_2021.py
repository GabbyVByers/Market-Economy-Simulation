...
pygame.display.set_caption("Market Simulation Version 4.1")
...
GermanyGraphTenHeight = 4000 #Wage Rate
...
GraphTenHeightMax = 4000
GraphElevenHeightMax = 0.05
GraphTwelveHeightMax = 500

GraphOneHeightMin = 5
GraphTwoHeightMin = 20
...
while run == True:
    ...
    for event in pygame.event.get():
        ...
        if (MouseOverDebugWindow == False) and (event.type == pygame.MOUSEBUTTONDOWN) and (SliderHitboxX < MouseX < SliderHitboxX + SliderHitboxWidth) and (SliderTenHitboxY < MouseY < SliderTenHitboxY + SliderHitboxHeight):
            SliderSelection = "Ten"
        if (MouseOverDebugWindow == False) and (event.type == pygame.MOUSEBUTTONDOWN) and (SliderHitboxX < MouseX < SliderHitboxX + SliderHitboxWidth) and (SliderElevenHitboxY < MouseY < SliderElevenHitboxY + SliderHitboxHeight):
            SliderSelection = "Eleven"
        if (MouseOverDebugWindow == False) and (event.type == pygame.MOUSEBUTTONDOWN) and (SliderHitboxX < MouseX < SliderHitboxX + SliderHitboxWidth) and (SliderTwelveHitboxY < MouseY < SliderTwelveHitboxY + SliderHitboxHeight):
            SliderSelection = "Twelve"
        if (MouseOverDebugWindow == False) and (event.type == pygame.MOUSEBUTTONDOWN) and (SliderHitboxX < MouseX < SliderHitboxX + SliderHitboxWidth) and (SliderThirteenHitboxY < MouseY < SliderThirteenHitboxY + SliderHitboxHeight):
